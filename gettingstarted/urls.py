...
urlpatterns = [
	...
	url(r'^holiday', hello.views.holiday, name='holiday'),
	url(r'^singleservice', hello.views.singleservice, name='singleservice'),
	url(r'^pricing', hello.views.pricing, name='pricing'),
